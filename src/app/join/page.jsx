...
//       companyName: form.companyName,
//       password: form.password,
//       telegramId: String(telegramId), // убедимся, что это строка
//       userName: form.userName,
//       workingStart: form.workingStart.length === 5
//         ? `${form.workingStart}:00`
//         : form.workingStart,
//       workingEnd: form.workingEnd.length === 5
//         ? `${form.workingEnd}:00`
//         : form.workingEnd,
//     });
...
//     router.push("/home");
//   } catch (e) {
//     console.error("Ошибка при создании компании:", e.response?.data || e.message);
//     alert(`Ошибка при создании компании: ${e.response?.data?.message || e.message}`);
//   }
// };
...
//         {mode === "create" ? "Создать компанию" : "Войти в компанию"}
//       </h2>
...
//       <button
//         className={`w-full py-3 rounded shadow text-white font-semibold transition
